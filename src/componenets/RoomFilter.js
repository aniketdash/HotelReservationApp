...
//get unique room types and capacity
        ...
        <section className="filter-container">
            ...
            <form className="filter-form">
                ...
                <div className="form-group">
                    <label htmFor="type">room type</label>
                ...
                {/* end of select */}
                 ...
                 {/* guest type */}
                 <div className="form-group">
                    <label htmFor="capacity">Guest</label>
                ...
                <div className="form-group">
                    <div className="single-extra">
                        ...
                        <label htmFor="breakfast">breakfast</label>
                    </div>
                    <div className="single-extra">
                        <input type="checkbox" name="pets" id="pets"
                         checked={pets} onChange={handleChange}/>
                        <label htmFor="pets">pets</label>
                    </div>
                </div>
